<template>
  <section class="mx-auto flex w-full max-w-3xl flex-col gap-8">
    <header class="space-y-3 rounded-3xl bg-white/80 p-8 shadow-md shadow-cyan-100/40 backdrop-blur dark:bg-slate-900/70">
      <p class="text-sm font-semibold uppercase tracking-[0.35em] text-cyan-500">Share a sighting</p>
